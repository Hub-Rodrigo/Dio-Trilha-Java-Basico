...
public class ExceptionCustomizada {
    public static void main(String[] args){
        String nomeDoArquivo = JOptionPane.showInputDialog("Nome do aquivo a ser exibido: ");
        ...
        try {
           ...
           JOptionPane.showMessageDialog(null , e.getMessage());
            ...
            JOptionPane.showMessageDialog(null,
                    "Ocorreu um erro não espererado, por favor, fala com o suporte." + ex.getMessage());
            ex.printStackTrace();
        }
    }
